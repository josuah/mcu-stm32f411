...
#define GPIOA ((struct zmcu_gpio *)0x40020000)
#define GPIOB ((struct zmcu_gpio *)0x40020400)
#define GPIOC ((struct zmcu_gpio *)0x40020800)
#define GPIOD ((struct zmcu_gpio *)0x40020C00)
#define GPIOE ((struct zmcu_gpio *)0x40021000)
#define GPIOH ((struct zmcu_gpio *)0x40021C00)
...
void gpio_port_set(struct zmcu_gpio *gpio, uint32_t mask);

/* for each bit set on `mask`, set the same pin down on port `base` */
void gpio_port_clear(struct zmcu_gpio *gpio, uint32_t mask);
